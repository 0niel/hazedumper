...
// 2020-06-29 09:14:38.784221100 UTC
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4D513BC;
constexpr ::std::ptrdiff_t dwForceAttack = 0x3182950;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x318295C;
constexpr ::std::ptrdiff_t dwForceBackward = 0x3182908;
constexpr ::std::ptrdiff_t dwForceForward = 0x3182914;
constexpr ::std::ptrdiff_t dwForceJump = 0x51FB064;
constexpr ::std::ptrdiff_t dwForceLeft = 0x318292C;
constexpr ::std::ptrdiff_t dwForceRight = 0x3182920;
constexpr ::std::ptrdiff_t dwGameDir = 0x629678;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x526E35C;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xD631AC;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58AAD8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x5299220;
constexpr ::std::ptrdiff_t dwInput = 0x51A2978;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x906494;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xD3CBEC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xD42790;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xD42760;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x3180CA0;
constexpr ::std::ptrdiff_t dwRadarBase = 0x518612C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xD53A7C;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD53A50;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x89FB0;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D42D04;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x51A3438;
constexpr ::std::ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xD47638;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xD415A;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
constexpr ::std::ptrdiff_t find_hud_element = 0x2D932C30;
constexpr ::std::ptrdiff_t force_update_spectator_glow = 0x3A1832;
constexpr ::std::ptrdiff_t interface_engine_cvar = 0x3E9EC;
constexpr ::std::ptrdiff_t is_c4_owner = 0x3AE2F0;
constexpr ::std::ptrdiff_t m_bDormant = 0xED;
constexpr ::std::ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ::std::ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x51863C8;
constexpr ::std::ptrdiff_t m_yawClassPtr = 0xD423F0;
constexpr ::std::ptrdiff_t model_ambient_min = 0x58DE4C;
constexpr ::std::ptrdiff_t set_abs_angles = 0x1D5A80;
constexpr ::std::ptrdiff_t set_abs_origin = 0x1D58C0;
} // namespace signatures
} // namespace hazedumper
