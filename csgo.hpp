...
// 2021-01-08 08:18:29.478446200 UTC
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4DA2E24;
constexpr ::std::ptrdiff_t dwForceAttack = 0x31D43B4;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x31D43C0;
constexpr ::std::ptrdiff_t dwForceBackward = 0x31D436C;
constexpr ::std::ptrdiff_t dwForceForward = 0x31D4378;
constexpr ::std::ptrdiff_t dwForceJump = 0x524CD84;
constexpr ::std::ptrdiff_t dwForceLeft = 0x31D4390;
constexpr ::std::ptrdiff_t dwForceRight = 0x31D4384;
constexpr ::std::ptrdiff_t dwGameDir = 0x62D7F8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x52C006C;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xDB2D7C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58ECE8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x52EB418;
constexpr ::std::ptrdiff_t dwInput = 0x51F4408;
...
constexpr ::std::ptrdiff_t dwPlayerResource = 0x31D26E0;
constexpr ::std::ptrdiff_t dwRadarBase = 0x51D7B9C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xDA216C;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xDA2140;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x8A1A0;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D94724;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x51F4EC8;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2919EED0;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x51D7E38;
